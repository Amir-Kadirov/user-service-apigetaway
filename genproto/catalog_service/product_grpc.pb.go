...
const (
	ProductService_Create_FullMethodName  = "/catalog_service.ProductService/Create"
	ProductService_GetByID_FullMethodName = "/catalog_service.ProductService/GetByID"
	ProductService_GetList_FullMethodName = "/catalog_service.ProductService/GetList"
	ProductService_Update_FullMethodName  = "/catalog_service.ProductService/Update"
	ProductService_Delete_FullMethodName  = "/catalog_service.ProductService/Delete"
)
...
type ProductServiceClient interface {
	...
	Delete(ctx context.Context, in *ProductPrimaryKey, opts ...grpc.CallOption) (*Empty1, error)
}
...
func (c *productServiceClient) Delete(ctx context.Context, in *ProductPrimaryKey, opts ...grpc.CallOption) (*Empty1, error) {
	out := new(Empty1)
...
type ProductServiceServer interface {
	...
	Delete(context.Context, *ProductPrimaryKey) (*Empty1, error)
...
func (UnimplementedProductServiceServer) Delete(context.Context, *ProductPrimaryKey) (*Empty1, error) {
