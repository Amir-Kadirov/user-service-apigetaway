...
func (c *branchServiceClient) Create(ctx context.Context, in *CreateBranch, opts ...grpc.CallOption) (*BranchPrimaryKey, error) {
	out := new(BranchPrimaryKey)
...
func (UnimplementedBranchServiceServer) Create(context.Context, *CreateBranch) (*BranchPrimaryKey, error) {
