...
type SellerServiceClient interface {
	Create(ctx context.Context, in *CreateSeller, opts ...grpc.CallOption) (*SellerPrimaryKey, error)
...
func (c *sellerServiceClient) Create(ctx context.Context, in *CreateSeller, opts ...grpc.CallOption) (*SellerPrimaryKey, error) {
...
func (c *sellerServiceClient) Delete(ctx context.Context, in *SellerPrimaryKey, opts ...grpc.CallOption) (*SellerEmpty, error) {
	out := new(SellerEmpty)
...
func (UnimplementedSellerServiceServer) Create(context.Context, *CreateSeller) (*SellerPrimaryKey, error) {
...
func (UnimplementedSellerServiceServer) Update(context.Context, *UpdateSellerRequest) (*UpdateSellerResponse, error) {
